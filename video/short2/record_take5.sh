...
echo "== step 0: full app reset =="
$ADB shell pm clear $PKG
$ADB shell appops set $PKG SYSTEM_ALERT_WINDOW allow
$ADB shell cmd statusbar add-tile $TILE >/dev/null 2>&1 || true
$ADB shell am start -n $PKG/com.granularvolume.MainActivity >/dev/null 2>&1
sleep 5
$ADB shell input tap 540 1583        # Agree and continue
sleep 2
$ADB shell input keyevent KEYCODE_HOME
sleep 1.5

echo "== step 1: dial ON at default dock, then one X tap: tooltip gone + service off =="
...
$ADB pull //sdcard/take.mp4 "D:\\Claude Projects\\claude\\Volume control\\video\\short2\\take_raw5.mp4"
$ADB shell rm //sdcard/take.mp4
echo "saved take_raw5.mp4"
