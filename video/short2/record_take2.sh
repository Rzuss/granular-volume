...
OUT="/d/Claude Projects/claude/Volume control/video/short2/take_raw2.mp4"
...
echo "== gate 2: media volume to 11 =="
for i in $(seq 1 15); do $ADB shell input keyevent KEYCODE_VOLUME_UP; sleep 0.12; done
for i in $(seq 1 4);  do $ADB shell input keyevent KEYCODE_VOLUME_DOWN; sleep 0.12; done
$ADB shell dumpsys audio | grep -A6 "STREAM_MUSIC:" | grep streamVolume
sleep 5   # native panel fades fully
...
$ADB pull //sdcard/take.mp4 "D:\\Claude Projects\\claude\\Volume control\\video\\short2\\take_raw2.mp4"
$ADB shell rm //sdcard/take.mp4
echo "saved take_raw2.mp4"
