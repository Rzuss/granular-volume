...
echo "== gate D: tile coordinate tap toggles the service on, X stops it =="
$ADB shell cmd statusbar expand-settings; sleep 2.5
$ADB shell input tap 285 207; sleep 2
$ADB shell cmd statusbar collapse; sleep 1.5
if ! svc_running; then echo "FATAL: tile tap does not start the service"; exit 1; fi
...
sleep 3   # let the shade animation settle fully before rolling
...
$ADB pull //sdcard/take.mp4 "D:\\Claude Projects\\claude\\Volume control\\video\\short2\\take_raw7.mp4"
$ADB shell rm //sdcard/take.mp4
echo "saved take_raw7.mp4"
