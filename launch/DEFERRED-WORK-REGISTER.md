...
| A2 | Split Terms of Use out of the privacy policy | `store-assets/privacy-policy.html` | Locked 2026-07-09. Move Disclaimer of Warranty, Limitation of Liability, and Governing law into a new `terms-of-use.html`. Add app copyright/license terms. Publish it to the separate `Rzuss/granular-volume-privacy` repo. Add a second footer link next to Privacy Policy on the landing page. Reason: a privacy policy is a notice document users never accept, so a liability cap sitting inside it may not be enforceable. |
...
| C7 | Add a purchase capacity clause to the Terms of Use | `terms-of-use.html`, created in A2 | Minors can void contracts. Word it around **purchases**, never around app use. An age gate on *using* a volume reduction utility protects nothing: COPPA is triggered by collecting data from under 13s and we collect none, and GDPR Article 8 governs consent for processing and we process nothing. |
