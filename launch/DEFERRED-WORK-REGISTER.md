...
| A2c | 🔴 MANDATORY, SAME BUILD AS A2b — Add a Legal section to the About screen | `MainActivity.kt` About screen | Two text links, "Terms of Use" and "Privacy Policy", opening the external browser. No need to embed the full text in the APK. Ship in the exact same release as A2b — both are the same "make consent real" unit of work, do not split across two versions. |
